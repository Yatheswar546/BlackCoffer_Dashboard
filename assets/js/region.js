        ...
        if (ajax_request.readyState == 4 && ajax_request.status == 200) {
            ...
            if (response.data.length > 0) {
                for (var count = 0; count < response.data.length; count++) {
                    ...
                    html += '<td>' + response.data[count].region + '</td>';
...
///////////////////////////////////// FILTERING ///////////////////////////////////////
/////////////////////// FETCH REGIONS /////////////////////////////
// Function to fetch regions from the API
function fetchRegions(callback) {
    fetch('http://localhost/blackCoffer/api/region.php', {
        method: 'GET',
        headers: {
...
function initializeTopicDropdown(regions) {
    const topicDropdown = document.querySelector('.dropdown-menu-regions');

    if (regions && regions.data && regions.data.length > 0) {
        regions.data.forEach((region) => { // Use topics.data here
            ...
            const topicText = document.createTextNode(region.region);
...
fetchRegions(initializeTopicDropdown);

/////////////////////// FETCH RECORDS BY SWOTS /////////////////////////////
$(document).ready(function () {
    $('#findRegions').click(function (event) {
        event.preventDefault();
        var action = 'searchRegions';
        var arr = [];
